...
const mockData = {
  ...
  streak: 7,
  goal: 4,
  weeklyProgress: [true, true, true, false], // 3 out of 4 workouts done
...
const ProfileHub = () => {
  ...
  const handleWorkoutTagClick = (workout: string) => {
    toast({
      ...
      description: `Showing only ${workout} posts`,
    });
  };
  ...
  return (
    <div className="min-h-screen bg-background pb-10">
      ...
      <div className="px-4 py-7">
        ...
        {/* My Workout Library Card */}
        <Card
          onClick={handleLibraryClick}
          className="mb-8 p-6 bg-dark-card border-dark-border rounded-[28px] cursor-pointer hover:bg-[#1A1A1A] transition-all"
          style={{ boxShadow: "0 0 20px rgba(93, 95, 236, 0.15)" }}
        >
